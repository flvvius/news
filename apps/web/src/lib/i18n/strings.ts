...
const ro = {
  ...
  "auth.signInSuccess": "Te-ai conectat",
  "auth.signInError": "Conectarea a eșuat. Încearcă din nou.",
  "auth.invalidEmail": "Adresă de email invalidă",
  ...
  "auth.needAccount": "Ai nevoie de un cont?",
  "auth.alreadyHaveAccount": "Ai deja cont?",
  "auth.resetEmailFirst":
    "Introdu mai întâi adresa de email ca să știm unde să trimitem linkul de resetare.",
  "auth.resetLinkFailed":
    "Nu am putut trimite linkul de resetare. Încearcă din nou.",
  "auth.resetLinkSent":
    "Dacă acel email există, am trimis un link de resetare a parolei.",
  "auth.resetSendingStatus": "Trimitem emailul pentru resetarea parolei...",
  "auth.checkEmailVerify": "Verifică emailul pentru a-ți confirma contul.",
  "auth.checkEmailVerifyDev":
    "Verifică emailul pentru a-ți confirma contul. Dacă nu apare nimic, folosește linkul de verificare afișat în logurile serverului.",
  "auth.unexpectedError": "A apărut o eroare neașteptată. Încearcă din nou.",
  "auth.verifyMissingEmail":
    "Nu ai primit emailul? Verifică spamul, apoi retrimite linkul de verificare la {email}.",
  "auth.verifyResendFailed":
    "Nu am putut retrimite emailul de verificare. Încearcă din nou.",
  "auth.verifyResent":
    "Emailul de verificare a fost trimis. Verifică inboxul pentru noul link.",
  "auth.verifyResending": "Trimitem emailul de verificare...",
  "auth.verifyResend": "Retrimite emailul de verificare",
  ...
  "activity.admin.confidence": "Raport de încredere",
  "activity.admin.maxTopics": "Topicuri maxime",
  ...
  "activity.admin.inferred": "Inferate",
  "activity.admin.input": "Date pentru inferență",
  ...
  "feed.authBody":
    "Poți citi totul anonim. Conectează-te doar când vrei salvări sincronizate, clasare adaptată intereselor tale și alerte viitoare.",
  ...
  "feed.latestCoverage": "Cea mai nouă acoperire",
  "feed.rankedCoverage": "Acoperire clasificată",
  ...
  "event.compareOriginal":
    "Acoperire agregată din mai multe surse. Compară mai jos relatările originale.",
  "event.left": "Stânga",
  ...
  "claim.leftExclusive": "Exclusiv stânga",
  ...
  "claim.rightExclusive": "Exclusiv dreapta",
  ...
  "claim.centerExclusive": "Exclusiv centru",
  "claim.centerExclusives": "Exclusive de centru",
  ...
  "source.metaDescriptionLoaded":
    "Analizează biasul, fiabilitatea, credibilitatea și acoperirea recentă pentru {name} pe Biviant.",
  ...
  "source.reliability": "Fiabilitate {count}/10",
  "source.recentArticles": "Articole recente",
  "source.events": "Evenimente",
  "source.aiBiasAvg": "Media biasului AI",
  ...
  "source.mean": "Media {count}",
  "source.stddev": "Abaterea standard {count}",
...
const en: { [K in keyof BaseStrings]: string } = {
  ...
  "feed.search.indexed": "Showing indexed search results for “{query}”.",
  ...
  "feed.latestCoverage": "Latest coverage",
  "feed.rankedCoverage": "Ranked coverage",
  ...
  "source.reliability": "Reliability {count}/10",
  "source.recentArticles": "Recent articles",
  "source.events": "Events",
  "source.aiBiasAvg": "AI bias avg",
  ...
  "source.mean": "Mean {count}",
  "source.stddev": "Stddev {count}",
