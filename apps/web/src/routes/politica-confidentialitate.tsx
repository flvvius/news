...
export const Route = createFileRoute("/politica-confidentialitate")({
  head: () => ({
    meta: [
      { title: "Politica de confidențialitate — Biviant" },
      {
        name: "description",
        content:
          "Ce date colectează Biviant, cu ce scop, cine le procesează și ce drepturi ai asupra lor.",
      },
    ],
  }),
...
export function PoliticaConfidentialitatePage() {
  return (
    <StaticPage
      ...
      intro="Pe scurt: poți citi Biviant fără cont; un cont adaugă funcții personale, iar datele tale rămân ale tale — le poți șterge oricând, complet."
    >
      ...
      <StaticSection heading="Ce date colectăm">
        <ul className="list-disc space-y-2 pl-5">
          <li>
            ...
            funcționării (loguri de server) și statistici de utilizare
            agregate, pseudonimizate, colectate prin PostHog (găzduit în
            Uniunea Europeană).
          </li>
          <li>
            <strong>Cu cont:</strong> adresa de e-mail, numele ales și
            parola (stocată exclusiv criptografic) — sau, dacă alegi
            autentificarea cu Google ori Apple, identificatorul și adresa de
            e-mail confirmate de furnizorul respectiv.
          </li>
          <li>
            <strong>Activitatea de citire</strong> (doar cu cont): ce
            evenimente deschizi, ce salvezi, timpul estimat de lectură și
            profunzimea derulării. Acestea alimentează funcțiile tale
            personale: salvările, seriile de zile de lectură și balanța de
            perspective.
          </li>
        </ul>
        <p>
          Nu vindem date personale și nu afișăm publicitate bazată pe
          profilare.
        </p>
      </StaticSection>
      ...
      <StaticSection heading="Cookie-uri și tehnologii similare">
        <p>
          Folosim cookie-uri strict necesare pentru sesiunea de autentificare
          și pentru preferințe (de exemplu limba aleasă), plus identificatori
          de analiză pseudonimizați pentru statistici de utilizare. Nu folosim
      ...
      <StaticSection heading="Cât timp păstrăm datele">
        <p>
          Datele contului și activitatea de citire se păstrează cât timp
          există contul. Conturile create cu e-mail și neverificate se șterg
          automat după 7 zile. Ștergerea contului o poți solicita din pagina
          de profil sau printr-o cerere scrisă; la ștergere se elimină datele
          asociate — profilul, salvările, istoricul de lectură și
          statisticile — și se declanșează cererea de ștergere a identității
          tale de analiză din PostHog.
        </p>
      </StaticSection>
      ...
      <StaticSection heading="Modificări ale politicii">
        <p>
          ...
          aplicație. Versiunea curentă este în vigoare de la{" "}
