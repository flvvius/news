...
const ro = {
  ...
  "activity.adminTitle": "Diagnostic pentru inferența categoriilor",
  "activity.adminBody":
    "Revizuiește alocările recente de categorii pentru evenimente",
  "activity.admin.minScore": "Scor minim",
  "activity.admin.confidence": "Coeficient de încredere",
  "activity.admin.maxTopics": "Număr maxim de categorii",
  "activity.admin.save": "Salvează setările",
  "activity.admin.saving": "Se salvează...",
  "activity.admin.reset": "Resetează",
  "activity.admin.saved":
    "Setările pentru inferența categoriilor au fost salvate.",
  ...
  "activity.admin.maxTopicsError":
    "Numărul maxim de categorii trebuie să fie un întreg între 1 și 5.",
  ...
  "profile.deleteDialogTitle": "Ștergi contul definitiv?",
  "profile.deleteConfirm":
    "Ștergerea este permanentă și include toate datele tale. Această acțiune nu poate fi anulată.",
  "profile.deleteCancel": "Anulează",
  ...
  "feed.topic.search": "Caută categorii...",
  "feed.topic.empty": "Nu am găsit categorii.",
  "feed.topic.all": "Toate categoriile",
  "feed.topic.single": "Categorie",
  "feed.topic.filter": "Filtrează după categorie",
  "feed.topic.drawerTitle": "Filtrează după categorie",
  "feed.topic.drawerBody": "Selectează o categorie pentru a filtra poveștile",
  ...
  "feed.preferredTopics": "Din categoriile tale preferate",
  ...
  "contact.field.name": "Nume",
  "contact.field.email": "E-mail",
  "contact.field.subject": "Subiect",
  "contact.field.message": "Mesaj",
  "contact.submit": "Trimite mesajul",
  "contact.submitting": "Se trimite...",
  "contact.error.name": "Scrie-ți numele.",
  "contact.error.email": "Adresa de e-mail nu pare validă.",
  "contact.error.message": "Mesajul este prea scurt.",
  "contact.error.generic": "Nu am putut trimite mesajul.",
  "contact.success.toast": "Mesajul a fost trimis. Mulțumim!",
  "contact.sent.title": "Mesajul a fost trimis.",
  "contact.sent.body":
  ...
  "source.reliabilityBand.veryHigh": "Foarte ridicată",
  "source.reliabilityBand.high": "Ridicată",
  "source.reliabilityBand.medium": "Medie",
  "source.reliabilityBand.low": "Scăzută",
  "source.reliabilityBand.veryLow": "Foarte scăzută",
  "source.reliabilityScale": "{score} din 10",
  "source.whyThisScore": "De ce acest scor",
...
const en: { [K in keyof BaseStrings]: string } = {
  ...
  "profile.deleteDialogTitle": "Delete your account permanently?",
  "profile.deleteConfirm":
    "Deletion is permanent and includes all your data. This action cannot be undone.",
  ...
  "contact.error.name": "Enter your name.",
  "contact.error.email": "That email address doesn't look valid.",
  "contact.error.message": "Your message is too short.",
  "contact.error.generic": "We couldn't send your message.",
  "contact.success.toast": "Your message has been sent. Thank you!",
  "contact.sent.title": "Your message has been sent.",
  "contact.sent.body":
  ...
  "source.reliabilityBand.veryHigh": "Very high",
  "source.reliabilityBand.high": "High",
  "source.reliabilityBand.medium": "Medium",
  "source.reliabilityBand.low": "Low",
  "source.reliabilityBand.veryLow": "Very low",
  "source.reliabilityScale": "{score} out of 10",
  "source.whyThisScore": "Why this score",
